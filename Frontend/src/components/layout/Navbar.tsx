      ...
      <header className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
        <div className="container navbar-inner">
          ...
          <div className="navbar-actions">
            <a href={`https://wa.me/${contactInfo.whatsapp}`} target="_blank" rel="noopener noreferrer" className="navbar-whatsapp">
        ...
        {menuOpen && (
          <div className="mobile-menu">
            {navLinks.map(link => (
              <button key={link.path} className={`mobile-link ${location.pathname === link.path ? 'mobile-link--active' : ''}`} onClick={() => handleNav(link.path)}>
                {link.label}
              </button>
            ))}
            <a href={`https://wa.me/${contactInfo.whatsapp}`} target="_blank" rel="noopener noreferrer" className="mobile-whatsapp">
